...
- Кнопка «Новый чат» с выбором: личный диалог или заготовка группового чата (сама группа будет реализована на следующем этапе, доступна для ролей doctor/admin).
