              ...
              {isAdmin ? (
                <>
                  ...
                  <button
                    ...
                    onClick={() =>
                      onConfirm(
                        `Вы действительно хотите создать группу "${groupTitle}"?`,
                        () => onCreateGroup()
                      )
                    }
                ...
                {groups.map((group) => (
                  <div key={group.id} className="group-card">
                    ...
                    <div className="btn-row">
                      {(group.membershipStatus === 'member' || group.membershipStatus === 'admin' || group.membershipStatus === 'owner') && (
                        <button type="button" className="primary-btn" onClick={() => onOpenChat(group.id)}>
                          Открыть
                        </button>
                      )}
                      {(isAdmin || group.membershipStatus === 'admin' || group.membershipStatus === 'owner') && (
